        ...
        namespace Wrapper {
            ...
            struct ExportShapefile : public Osmium::Javascript::Template {
                ...
                static void add_string_attribute(Osmium::Export::Shapefile* shapefile, int n, v8::Local<v8::Value> value) {
                    ...
                    int32_t destCapacity = (Osmium::Export::Shapefile::max_dbf_field_length+1)*4;
                    ...
                    icu::UnicodeString str(source);
                    str.extract(dest, shapefile->field(n).width(), shapefile->get_char_converter(), error_code);
